...
import project.common.validation.implementation.customer.IdentityDocumentNoValidator;
...
public @interface ValidIdentityDocumentNo {
    String message() default "Identity document number should be at least 1 " +
